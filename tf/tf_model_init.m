...
industry_sic_code_index = Index(get_single_sql_result(conn, ...
    'SELECT max(industry_sic_code) FROM company_tf_observation'));

%city_index = Index(get_single_sql_result(conn, ...
    %'SELECT max(city) FROM company_tf_observation'));

state_index = Index(get_single_sql_result(conn, ...
    'SELECT max(state) FROM company_tf_observation'));
